...
function Checkout()
{
    ...
    // INSERT INTO `order`(`id`, `total`) VALUES ('[value-1]','[value-2]')
    // INSERT INTO `order_details`(`id`, `product_id`, `product_qty`, `product_price`, `cart_id`) VALUES ('[value-1]','[value-2]','[value-3]','[value-4]','[value-5]')
